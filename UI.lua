...
function Library:CreateWindow(WindowInfo)
    ...
    if Library.IsMobile then
        ...
        ToggleCorner.CornerRadius = UDim.new(0, 15) -- 15像素大圆角
        ToggleCorner.Parent = ToggleButton.Button -- 注意：这里要加在 .Button 上
        ...
        LockCorner.CornerRadius = UDim.new(0, 15) -- 15像素大圆角
        LockCorner.Parent = LockButton.Button

        -- 3. 这里的坐标逻辑保持不变，确保它们靠左或靠右对齐
