...
function Library:CreateWindow(WindowInfo)
    ...
    if Library.IsMobile then
        local ToggleButton = Library:AddDraggableButton("切换UI", function()
            Library:Toggle()
        end, true)

        local ToggleCorner = Instance.new("UICorner")
        ToggleCorner.CornerRadius = UDim.new(0, 30)--15像素
        ToggleCorner.Parent = ToggleButton.Button
        ...
        LockCorner.CornerRadius = UDim.new(0, 30)--15像素
        LockCorner.Parent = LockButton.Button
